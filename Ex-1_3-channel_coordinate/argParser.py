...
def initArgs():
    ...
    parser.add_argument("-pretrainedPath",type=str,dest="pretrainedPath",help="Path to the pretrained weights used to adapt the first conv layer (default savedModels/MedicalPatchNet_weights.pt)",default="savedModels/MedicalPatchNet_weights.pt")
    ...
    PRETRAINED_WEIGHTS_PATH = args.pretrainedPath 