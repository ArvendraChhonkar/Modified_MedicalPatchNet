...
class Trainer:
    ...
    def _runEpoch(self, epoch):
        ...
        if hasattr(self.model, 'film_gamma'):
            ...
            # Only FiLMPatchNet has a direct .classifier and .film_* attributes
            if hasattr(self.model, 'classifier'):
                print("Classifier Weight Norm:", self.model.classifier.weight.norm().item())
            print("Gamma mean:", gamma.mean().item())
            print("Gamma std:",  gamma.std().item())
            print("Beta mean:",  beta.mean().item())
            print("Beta std:",   beta.std().item())
